    ...
    <section class="container_login_pri">
        ...
        <div class="container_login">
            ...
            <div class="container_seta">
                <a href="index.html"><img src="/lavonline/assents/imgs/login/seta.png" alt="Seta"></a>
            </div>
            ...
            <div class="container_tittle">
                ...
                <p>Selecione um método de login:</p>
                ...
                <form action="{{ route('user.login') }}" class="form" method="POST">
                    ...
                    <div class="container_btn_escquece">
                        <a class="btn_escpass" href="">Esqueceu sua senha?</a>
                    </div>
